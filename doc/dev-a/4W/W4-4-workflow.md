...
## 작업 목록
<!-- TODO 1. HospitalRule — target, startDate, endDate 필드 추가 -->
<!-- TODO 2. Reservation — startTime, endTime 필드 추가 -->
<!-- TODO 3. DoctorSchedule — 신규 Entity (HMS Doctor 참조) -->
<!-- TODO 4. MedicalHistory — 신규 Entity (HMS Staff 참조) -->
<!-- TODO 5. MedicalContent — 신규 Entity -->
<!-- TODO 6. MedicalQa — 신규 Entity -->
<!-- TODO 7. MedicalDomain — 신규 Entity -->
<!-- TODO 8. ChatbotHistoryRepository — 신규 Repository -->
<!-- TODO 9. LLM Entity Repository 5개 신규 추가 -->
<!-- TODO 10. 빌드 확인 -->
