...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (path.includes("dashboard.html")) titleEl.textContent = "물품 담당자 대시보드";
  else if (path.includes("item-list.html")) titleEl.textContent = "물품 관리";
  else if (path.includes("item-form.html")) titleEl.textContent = "물품 등록/수정";
  else if (path.includes("item-history.html")) titleEl.textContent = "입출고 내역";
});
