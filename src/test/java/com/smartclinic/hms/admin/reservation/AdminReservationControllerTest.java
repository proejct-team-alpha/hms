...
// import
// com.smartclinic.hms.admin.reservation.dto.AdminReservationListResponse;
// import
// com.smartclinic.hms.admin.reservation.dto.AdminReservationPageLinkResponse;
// import
// com.smartclinic.hms.admin.reservation.dto.AdminReservationStatusOptionResponse;
...
// @WebMvcTest(value = AdminReservationController.class, properties = {
...
// private static final String CANCEL_SUCCESS_MESSAGE = "\uC608\uC57D\uC774
// \uCDE8\uC18C\uB418\uC5C8\uC2B5\uB2C8\uB2E4.";
// private static final String INVALID_STATUS_MESSAGE = "\uCDE8\uC18C\uD560
// \uC218 \uC5C6\uB294 \uC0C1\uD0DC\uC785\uB2C8\uB2E4.";
...
// List.of(),
// List.of(new AdminReservationStatusOptionResponse("ALL", "ALL",
// "/admin/reservation/list?page=1&size=10&status=ALL", true)),
// List.of(new AdminReservationPageLinkResponse(1,
// "/admin/reservation/list?page=1&size=10&status=ALL", true)),
// "ALL",
// 0,
// 1,
...
// "",
// "");
// given(adminReservationService.getReservationList(1, 10,
// null)).willReturn(viewModel);
...
// "");
// given(adminReservationService.getReservationList(2, 5,
// "RESERVED")).willReturn(viewModel);
...
// "/admin/reservation/list?page=2&size=10&status=RECEIVED")))
...
// // given
// willThrow(new CustomException("INVALID_STATUS_TRANSITION",
// INVALID_STATUS_MESSAGE, HttpStatus.CONFLICT))
...
// .andExpect(status().isFound())
// .andExpect(header().string("Location", containsString(
// "/admin/reservation/list?page=2&size=10&status=COMPLETED")))
